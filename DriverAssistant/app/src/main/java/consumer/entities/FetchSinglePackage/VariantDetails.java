...
public class VariantDetails {
    ...
    public VariantDetails(Integer id, Boolean phone, Boolean chat, Boolean video, Integer actualPrice, Integer offerPrice, String duration, Integer consultations) {
        this.id=id;
        this.phone_support=phone;
        this.chat_support=chat;
        this.video_support=video;
